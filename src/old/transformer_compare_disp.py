...
from misc import index_representation, resamp
...
vs_obs = np.array(vs_obs*100, dtype=int)

vs_obs = vs_obs.reshape(1, vs_obs.shape[0])
...
model_name = f'{path_models}[202405151940]_transformer_model.keras'
